...
CLI config `13 passed in 1.38s`; source/package `9 passed in 0.63s`;
Ruff clean and `104 files already formatted`; pretraining validator `pass`;
SWAG validator `pass`. SWAG source/harness is
